...
class imdb {
 ...
 private:
  ...
  char* binarySearch(char fileName, string s, int year) const;
  void collectFilms(char* chars, vector < film >& films, string player) const;
  void collectActors(char* chars, vector < string >& players, string movie) const;
